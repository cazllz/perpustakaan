...
@section('content')
{{-- 🔥 library SweetAlert2 langsung di file ini agar pop-up kamu aktif --}}
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
<link href="https://cdn.jsdelivr.net/npm/remixicon@4.2.0/fonts/remixicon.css" rel="stylesheet">

<style>
    /* --- CSS INJECTOR: MEMBONGKAR STRUKTUR LAYOUT BIAR KEMBALI LUXE --- */
    body {
        background-color: #F5EFE6 !important; /* Memaksa latar belakang menjadi cream premium */
    }
    ...
    .status-dipinjam { background: #E5F9FF; color: #0984E3; border-color: rgba(9, 132, 227, 0.2); }
    
    {{-- 🔥 WARNA SINKRON: Menyelaraskan status dikembalikan dengan warna hijau emerald soft milik file laporan --}}
    .status-dikembalikan, .status-kembali { background: #E5FFF1; color: #27AE60; border-color: rgba(39, 174, 96, 0.2); }
    
    {{-- 🔥 WARNA RESMI: Status ditolak menggunakan warna merah soft mewah --}}
    .status-ditolak { background: #FFF4F2; color: #D48E7E; border-color: rgba(212, 142, 126, 0.2); }
    ...
    <div class="stats-strip">
        <div class="stat-card-luxe">
            ...
            <div>
                ...
                {{-- 🔥 FIX SINKRONISASI ELEQUENT: Diubah menjadi count() agar klop membaca format array dari get() tanpa eror 500 --}}
                <div style="font-size: 28px; font-weight: 900;">{{ $peminjamans->count() }}</div>
            </div>
        </div>
        <div class="stat-card-luxe">
            ...
            <div>
                ...
                <div style="font-size: 28px; font-weight: 900;">{{ $peminjamans->whereIn('status', ['diajukan', 'pending', 'menunggu'])->count() }}</div>
            </div>
        </div>
        <div class="stat-card-luxe">
            ...
            <table class="premium-table" id="peminjamanTable">
                ...
                <tbody>
                    ...
                    <tr class="borrow-row">
                        ...
                        <td>
                            {{-- 🔥 SINKRONISASI BADGE: Otomatis mendeteksi status string 'kembali', 'dikembalikan', atau 'ditolak' --}}
