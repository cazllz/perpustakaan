...
<div class="workspace-wrapper">
    <div class="nexus-form-container">
        ...
        <div style="border-left: 6px solid #D4A373; padding-left: 20px; margin-bottom: 35px;">
            <h2 style="font-weight: 900; font-size: 34px; letter-spacing: -1.5px; margin: 0; color: #2C1F17;">Tambah Buku Baru.</h2>
        ...
        <form action="{{ route($prefix . '.buku.simpan') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-layout-nexus">
                ...
                <div class="bento-panel-form">
                    ...
                    <div class="form-fields-grid">
                        <div class="form-group form-group-full">
                            ...
                            <input type="text" name="judul" class="form-input-premium" placeholder="Masukkan judul buku..." required autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label class="form-label-premium">Penulis</label>
                            <input type="text" name="penulis" class="form-input-premium" placeholder="Nama pengarang..." required autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label class="form-label-premium">Penerbit</label>
                            <input type="text" name="penerbit" class="form-input-premium" placeholder="Nama penerbit..." required autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label class="form-label-premium">Tahun Terbit</label>
                            <input type="number" name="tahun" class="form-input-premium" placeholder="2026" required value="{{ date('Y') }}">
                        </div>

                        <div class="form-group">
                            <label class="form-label-premium">Stok Buku</label>
                            <input type="number" name="stok" class="form-input-premium" min="1" placeholder="Jumlah unit..." required>
                        </div>
                        ...
                        <div class="form-group form-group-full">
                            <label class="form-label-premium">Sinopsis / Deskripsi Buku</label>
                            <textarea name="deskripsi" class="form-textarea-premium" placeholder="Tulis sinopsis cerita buku secara singkat di sini..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bento-panel-form">
                    ...
                    <div class="preview-box-premium" id="previewContainer">
                        ...
                        <div class="preview-placeholder" id="placeholderText" style="text-align:center;">
                            <i class="ri-image-add-line" style="font-size: 36px; color:#D4A373; opacity: 0.6;"></i>
                            <p style="font-size: 10px; font-weight: 800; margin: 8px 0 0; letter-spacing: 1px; color: #A89C90;">BELUM ADA ASSET</p>
                        </div>
                    </div>
            ...
            <div style="display: flex; justify-content: flex-end; gap: 15px; margin-top: 30px; border-top: 1.5px solid #EFEBE4; padding-top: 25px;">
                <a href="{{ url($prefix . '/buku') }}" class="btn-cancel">BATALKAN PROSES</a>
                <button type="submit" class="btn-submit-premium">
                    <i class="ri-checkbox-circle-fill"></i> REKAM DATA KOLEKSI
                </button>
            </div>
        </form>
