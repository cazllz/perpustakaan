@extends('layouts.admin') {{-- 🔥 Kembali menggunakan layout utama bawaan kamu --}}
...
<div class="admin-workspace">
    {{-- 🔥 FIXED FONT: Plus Jakarta Sans tebal lurus tanpa menggunakan font serif miring --}}
                        ...
                        <td align="center">
                            <div style="display: flex; justify-content: center; gap: 12px; align-items: center;">
                                @if($st == 'diajukan' || $st == 'pending')
                                    <a href="{{ route('petugas.setujui', $p->id) }}" class="btn-action btn-approve" title="Setujui">
    ...
    function confirmReject(id, userName) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `{{ url('/') }}/petugas/tolak/${id}`;
            }
        });
    }
</script>
